...
path = os.getcwd() + '/Ransomware_shuffled.csv'
ori_data = open(path)
data = []
dataY = []
...
log_path = './log_1layer_gru_lr=0.001/'
model_name = log_path + './1_layer_gru.h5'
...
lstmout1 = GRU(units = 256, return_sequences = False, dropout = 0.1, recurrent_dropout = 0.1)(inputemb)
