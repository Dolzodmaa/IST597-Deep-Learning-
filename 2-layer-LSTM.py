...
log_path = './log_2layer_lstm_lr=0.001/'
model_name = log_path + './2_layer_lstm.h5'
...
lstmout2 = (LSTM(units=128, return_sequences=False, dropout=0.5, recurrent_dropout=0.5))(lstmout1)
out = Dense(len(idmapy), activation='softmax', name='out')(lstmout2)
